...
st.set_page_config(page_title="Lung Cancer Prediction System", layout="wide")
...
# Header
st.markdown("<div class='header'>Lung Cancer Prediction System</div>", unsafe_allow_html=True)
...
def predict():
    ...
    low_risk_percentage = prediction[0][0] * 100  # Confidence score for "High Risk" class
    medium_risk_percentage = prediction[0][1] * 100  # Confidence score for "High Risk" class
    ...
    st.session_state['low_risk_percentage'] = low_risk_percentage
    st.session_state['medium_risk_percentage'] = medium_risk_percentage
...
if st.session_state['page'] == 'home':
    if not st.session_state['show_result']:
        ...
        with col1:
            # Display the specific risk percentage
        ...
        with col2:    
            ...
            risk_percentages = [
            st.session_state['low_risk_percentage'],
            st.session_state['medium_risk_percentage'],
            st.session_state['high_risk_percentage']
            ]

            # Plotting the bar chart
            fig, ax = plt.subplots(figsize=(3, 2),dpi=50)
            ax.bar(risk_levels, risk_percentages, color=['lightblue', 'orange', 'red'])
            ax.set_xlabel("Risk Level")
            ax.set_ylabel("Percentage (%)")
            ax.set_title("Predicted Risk Levels for Lung Cancer")
            ax.set_ylim(0, 100)
    ...
    st.markdown("<h2>Blogs</h2>", unsafe_allow_html=True)
    
    with col1:
        
        
        st.markdown("### Understanding Lung Cancer")
        st.image("/Users/shelomi/Documents/UNITEC/Data Analytics and Intelligence/Assignment2/App/images/1.png", width=500)
        ...
        st.image("/Users/shelomi/Documents/UNITEC/Data Analytics and Intelligence/Assignment2/App/images/2.jpg", width=500)
        ...
        st.image("/Users/shelomi/Documents/UNITEC/Data Analytics and Intelligence/Assignment2/App/images/3.jpg", width=500)
    ...
    with col2:
        ...
        st.image("/Users/shelomi/Documents/UNITEC/Data Analytics and Intelligence/Assignment2/App/images/4.jpg", width=500)
        ...
        st.image("/Users/shelomi/Documents/UNITEC/Data Analytics and Intelligence/Assignment2/App/images/5.jpg", width=500)
    ...
    st.markdown("### 1. What is the purpose of this Lung Cancer Prediction System?")
